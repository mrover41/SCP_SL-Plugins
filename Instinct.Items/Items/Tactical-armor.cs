...
namespace Instinct.Items.Instinct.Items {
    internal class Tactical_armor : LabApi.CustomItems.API.Features.CustomItem {
        ...
        protected override void SubscribeEvents() {
            LabApi.Events.Handlers.Player.ChangedItem += OnSelect;
        ...
        private void OnSelect(LabApi.Events.EventArgs.Player.ChangedItemEventArgs ev) {
            if (Check(ev.Item)) {
